...
<p>
As of this writing, my website actually isn't even done (although is it <i>ever</i>?).
I am actually writing this first post in raw HTML because my markdown parser isn't done.
...
a Pi on campus. However, both the operating system and harware are subject to signifigant change though. This includes sometimes 
...
<p>My <code>.htaccess</code> actually forwards all requests to a single document, <code>index.php</code>.That page takes the
...
enabled. This has a cool side-effect of making the site more usable by making URL navigation still possible. That said, things like the
